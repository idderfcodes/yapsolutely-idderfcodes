    ...
    <DashboardLayout>
      <div className="p-5 sm:p-6 lg:p-8 max-w-[1100px]">
        ...
        <div className="flex items-center justify-between mb-5">
          <div>
            <h1 className="font-display text-[1.12rem] font-semibold tracking-[-0.02em] text-text-strong">Knowledge Base</h1>
            <p className="font-body text-[0.72rem] text-text-subtle mt-0.5">Sources that inform your agents' responses.</p>
          </div>
          <button className="font-body text-[0.72rem] text-text-subtle/50 px-2.5 py-1 rounded border border-border-soft/40 cursor-not-allowed">
            Add source
          </button>
        </div>
        ...
        <div className="bg-surface-panel rounded-card border border-border-soft overflow-hidden mb-5">
          <div className="px-4 py-3 border-b border-border-soft/60">
            <h3 className="font-display text-[0.8rem] font-medium text-text-strong">Sources</h3>
          </div>
        ...
        <div className="bg-surface-panel rounded-card border border-border-soft px-6 py-10 text-center">
          ...
          <h3 className="font-display text-[0.82rem] font-medium text-text-strong mb-0.5">No sources yet</h3>
