...
export function Header() {
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-50 mx-auto w-full max-w-5xl border-b border-transparent px-4 pt-4 md:rounded-md md:border md:px-0 md:transition-all md:ease-out",
        {
          "bg-background/95 border-border shadow-surface-lg supports-[backdrop-filter]:bg-background/50 backdrop-blur-lg md:top-4 md:max-w-4xl":
            scrolled && !open,
          "bg-background/90 md:top-4 md:max-w-4xl": open,
        },
      )}
    >
      <nav
      ...
      >
        <Link href="/" className="text-text-strong transition-opacity hover:opacity-80" aria-label="Yapsolutely home">
